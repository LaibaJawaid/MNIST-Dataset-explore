...
def train_Model():
    ...
    # CNNs typically need an extra channel dimension (28, 28, 1)
    ...
    st.sidebar.success(f"Testing Accuracy{test_acc:.4f}")
    return model
...
if option == "Draw a Number":
    ...
    # 2. Reshape and normalize (add channel dimension if using a CNN)
    # If using CNN:
